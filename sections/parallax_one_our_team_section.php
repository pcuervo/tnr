...
?>
		...
		<section class="services" id="videos" role="region" aria-label="<?php esc_html_e('Services','parallax-one') ?>">
					...
					<div class="section-header">
						<?php
							if( !empty($parallax_one_our_services_title) ){
								echo '<h2 class="dark-text">Videos</h2><div class="colored-line"></div>';
